...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($usernameError) && empty($emailError) && empty($passwordError) && empty($confirmPasswordError)) {
        ...
        if ($emailCheckResult->num_rows > 0) {
            ...
            // Hash the password using password_hash function that uses PASSWORD_DEFAULT parameter. This parameter states the bcrypt algorithm
            ...
            // "sss": data type of placeholders. Other options: s: String. i: Integer. d: Double (floating point). b: Blob (binary data). Since username, email, and password are all strings, "sss" is used.
